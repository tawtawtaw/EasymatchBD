...
/** Maps biodata field keys to admin dropdown categories. */
...
/** profile.fields translation groups when dropdown lookup misses. */
...
/** English fallbacks when dropdown + i18n lookup both miss (e.g. stale cache). */
